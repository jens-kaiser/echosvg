...
public final class DefaultFontFamilyResolver implements FontFamilyResolver {
	...
	private static final List<AWTFontFamily> awtFontFamilies = new ArrayList<>();

	private static final List<AWTGVTFont> awtFonts = new ArrayList<>();
	 ...
	 */
	private static final Map<String, GVTFontFamily> resolvedFontFamilies = new HashMap<>();
