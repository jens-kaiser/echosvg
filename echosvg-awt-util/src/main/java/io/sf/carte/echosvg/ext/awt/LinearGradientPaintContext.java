...
final class LinearGradientPaintContext extends MultipleGradientPaintContext {
	...
	private void fillHardNoCycle(int[] pixels, int off, int adjust, int x, int y, int w, int h) {
	...
	private void fillSimpleNoCycle(int[] pixels, int off, int adjust, int x, int y, int w, int h) {
		// constant which can be pulled out of the inner loop
		final float initConst = (dgdX * x) + gc;
	...
	private void fillSimpleRepeat(int[] pixels, int off, int adjust, int x, int y, int w, int h) {
	...
	private void fillSimpleReflect(int[] pixels, int off, int adjust, int x, int y, int w, int h) {
		final float initConst = (dgdX * x) + gc;
